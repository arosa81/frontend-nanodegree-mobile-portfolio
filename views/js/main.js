...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images_compressed/pizza-large_large.png";
...
var resizePizzas = function(size) {
  ...
  /** Changes the value for the size of the pizza above the slider
      Updated to return size value - will be passed along to changePizzaSizes(size)
      and removed determineDx (elem, size) function since switch is duplicated.
      Also changed selector function from .querySelector to .getElementById
  **/
  ...
  /** Iterates through pizza elements on the page and changes their widths
      Refactored to read layout properties then batch style changes. Removing all unneeded calculations from within the for-loop. Also changed selector from .querySelectorAll to .getElementsByClassName
  **/
...
// Attempted to optimize by reading layout properties then batch style changes
...
for (var i = 2; i < 100; i++) {
  ...
  ranPizzaContainer[i].id = "pizza" + i;                // gives each pizza element a unique id
}
...
/**
  Attempted to optimize by removing as many calculations performed at the time
  that it assigned to style. I believe I broke this functionality and I don't think I
  improved performance here, but I am stuck at this point for optimization ideas.
**/
